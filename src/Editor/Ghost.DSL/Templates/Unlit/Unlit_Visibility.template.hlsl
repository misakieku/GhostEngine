// ============================================================
// GhostEngine UnlitTemplate - Visibility Pass
// ============================================================
// GPU-driven depth pass for visibility/occlusion. The pixel
// shader exists only for masked variants (GHOST_HAS_ALPHA_CLIP)
// but is always compiled so the entry point is present.
//
