// ============================================================
// GhostEngine UnlitTemplate - Forward Pass
// ============================================================
// Full forward rasterization: mesh shader decompresses the
// meshlet, pixel shader evaluates the unlit color with optional
// alpha clipping. Used for translucent / emissive geometry.
//
// Injection points used:
//   GetAlphaCoverage(materialIndex, uv, payload) -> alpha clip (optional)
//   GetColor(materialIndex, uv, payload)         -> final color  (fallback provided)
// ============================================================
...
float4 PSMain(PSInput input) : SV_TARGET
{
    ...
    return GetColor(input.materialIndex, input.uv, payload);
}
