// ============================================================
// GhostEngine UnlitTemplate - Shadow Pass
// ============================================================
// Depth-only shadow rasterization. Identical structure to the
// visibility pass but targeted at shadow map views. Masked
// variants clip via GetAlphaCoverage().
//
