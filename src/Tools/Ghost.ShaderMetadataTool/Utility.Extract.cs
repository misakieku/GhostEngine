...
{
    public static void ExtractShaderProperties(ShaderMetadata manifest, string text)
    {
        ...
        foreach (var structDecl in structDeclarations)
        {
            var attribute = structDecl.AttributeLists
                ...
                .FirstOrDefault(a =>
                {
                    ...
                    return name == "GenerateShaderProperty" ||
                           name.EndsWith(".GenerateShaderPropertyAttribute") ||
                           name.EndsWith(".GenerateShaderProperty");
                });
            ...
            manifest.ReflectionDatas[shaderName] = new ShaderReflectionData
            {
