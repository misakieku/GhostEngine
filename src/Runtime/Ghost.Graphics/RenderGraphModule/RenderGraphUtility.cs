...
public static class RenderGraphUtility
{
    ...
    /// </summary>
    public static unsafe void AddClearBufferPass(
        this RenderGraph rg,
        Identifier<RGBuffer> targetBuffer,
        ulong sizeInBytes = 0,
        uint clearValue = 0,
        string passName = "ClearBuffer")
    {
        if (sizeInBytes == 0)
        {
    ...
    /// </summary>
    public static void AddCopyBufferPass(
        this RenderGraph rg,
        Identifier<RGBuffer> dstBuffer,
        Identifier<RGBuffer> srcBuffer,
        ulong numBytes = 0,
        ulong dstOffset = 0,
        ulong srcOffset = 0,
        string passName = "CopyBuffer")
    {
        if (numBytes == 0)
        {
    ...
    /// </summary>
    public static void AddCopyTexturePass(
        this RenderGraph rg,
        Identifier<RGTexture> dstTexture,
        Identifier<RGTexture> srcTexture,
        string passName = "CopyTexture")
    {
    ...
    /// </summary>
    public static void AddClearRenderTargetPass(
        this RenderGraph rg,
        Identifier<RGTexture> target,
        Color128 clearColor,
        string passName = "ClearRenderTarget")
    {
    ...
    /// </summary>
    public static void AddClearDepthStencilPass(
        this RenderGraph rg,
        Identifier<RGTexture> target,
        ...
        string passName = "ClearDepthStencil")
    {
