...
#pragma warning restore 414
    ...
    */
    public struct System
    {
        ...
        public readonly RESULT getDriverInfo(int id, out string name, int namelen, out Guid guid, out int systemrate, out SPEAKERMODE speakermode, out int speakermodechannels)
        {
            var stringMem = Marshal.AllocHGlobal(namelen);

            var result = FMOD5_System_GetDriverInfo(handle, id, stringMem, namelen, out guid, out systemrate, out speakermode, out speakermodechannels);
        ...
        {
            using var encoder = StringHelper.GetFreeHelper();
            return FMOD5_System_CreateSound(handle, encoder.byteFromStringUTF8(name)!, mode, ref exinfo, out sound.handle);
        }
        ...
        {
            using var encoder = StringHelper.GetFreeHelper();
            return FMOD5_System_CreateStream(handle, encoder.byteFromStringUTF8(name)!, mode, ref exinfo, out sound.handle);
        }
        ...
        public readonly RESULT getRecordDriverInfo(int id, out string name, int namelen, out Guid guid, out int systemrate, out SPEAKERMODE speakermode, out int speakermodechannels, out DRIVER_STATE state)
        {
            ...
            var result = FMOD5_System_GetRecordDriverInfo(handle, id, stringMem, namelen, out guid, out systemrate, out speakermode, out speakermodechannels, out state);
    ...
    */
    public struct DSP
    {
        ...
        {
            return FMOD5_DSP_SetParameterData(handle, index, data, data == null ? 0 : (uint)data.Length);
        }
