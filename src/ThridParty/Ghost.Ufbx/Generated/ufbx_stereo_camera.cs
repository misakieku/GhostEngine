...
{
    /// <include file='ufbx_stereo_camera.xml' path='doc/member[@name="ufbx_stereo_camera"]/*' />
    public unsafe partial struct ufbx_stereo_camera
    {
        /// <include file='ufbx_stereo_camera.xml' path='doc/member[@name="ufbx_stereo_camera.Anonymous"]/*' />
        [NativeTypeName("__AnonymousRecord_ufbx_L1831_C2")]
        public _Anonymous_e__Union Anonymous;

        /// <include file='ufbx_stereo_camera.xml' path='doc/member[@name="ufbx_stereo_camera.left"]/*' />
        public ufbx_camera* left;

        /// <include file='ufbx_stereo_camera.xml' path='doc/member[@name="ufbx_stereo_camera.right"]/*' />
