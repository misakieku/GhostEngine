...
{
    /// <include file='ufbx_pose.xml' path='doc/member[@name="ufbx_pose"]/*' />
    public partial struct ufbx_pose
    {
        /// <include file='ufbx_pose.xml' path='doc/member[@name="ufbx_pose.Anonymous"]/*' />
        [NativeTypeName("__AnonymousRecord_ufbx_L3462_C2")]
        public _Anonymous_e__Union Anonymous;

        /// <include file='ufbx_pose.xml' path='doc/member[@name="ufbx_pose.is_bind_pose"]/*' />
        [NativeTypeName("_Bool")]
        public bool is_bind_pose;

        /// <include file='ufbx_pose.xml' path='doc/member[@name="ufbx_pose.bone_poses"]/*' />
