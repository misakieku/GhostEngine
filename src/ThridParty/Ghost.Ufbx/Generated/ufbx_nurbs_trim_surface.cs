...
{
    /// <include file='ufbx_nurbs_trim_surface.xml' path='doc/member[@name="ufbx_nurbs_trim_surface"]/*' />
    public partial struct ufbx_nurbs_trim_surface
    {
        /// <include file='ufbx_nurbs_trim_surface.xml' path='doc/member[@name="ufbx_nurbs_trim_surface.Anonymous"]/*' />
