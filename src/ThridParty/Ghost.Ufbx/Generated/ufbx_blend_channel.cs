...
{
    /// <include file='ufbx_blend_channel.xml' path='doc/member[@name="ufbx_blend_channel"]/*' />
    public unsafe partial struct ufbx_blend_channel
    {
        /// <include file='ufbx_blend_channel.xml' path='doc/member[@name="ufbx_blend_channel.Anonymous"]/*' />
        [NativeTypeName("__AnonymousRecord_ufbx_L2079_C2")]
        public _Anonymous_e__Union Anonymous;

        /// <include file='ufbx_blend_channel.xml' path='doc/member[@name="ufbx_blend_channel.weight"]/*' />
        [NativeTypeName("ufbx_real")]
        public float weight;

        /// <include file='ufbx_blend_channel.xml' path='doc/member[@name="ufbx_blend_channel.keyframes"]/*' />
        public ufbx_blend_keyframe_list keyframes;

        /// <include file='ufbx_blend_channel.xml' path='doc/member[@name="ufbx_blend_channel.target_shape"]/*' />
