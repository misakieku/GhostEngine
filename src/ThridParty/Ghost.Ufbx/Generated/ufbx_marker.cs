...
{
    /// <include file='ufbx_marker.xml' path='doc/member[@name="ufbx_marker"]/*' />
    public partial struct ufbx_marker
    {
        /// <include file='ufbx_marker.xml' path='doc/member[@name="ufbx_marker.Anonymous"]/*' />
        [NativeTypeName("__AnonymousRecord_ufbx_L1865_C2")]
        public _Anonymous_e__Union Anonymous;

        /// <include file='ufbx_marker.xml' path='doc/member[@name="ufbx_marker.type"]/*' />
