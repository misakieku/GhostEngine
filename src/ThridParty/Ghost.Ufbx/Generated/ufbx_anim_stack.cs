...
{
    /// <include file='ufbx_anim_stack.xml' path='doc/member[@name="ufbx_anim_stack"]/*' />
    public unsafe partial struct ufbx_anim_stack
    {
        /// <include file='ufbx_anim_stack.xml' path='doc/member[@name="ufbx_anim_stack.Anonymous"]/*' />
        [NativeTypeName("__AnonymousRecord_ufbx_L3091_C2")]
        public _Anonymous_e__Union Anonymous;

        /// <include file='ufbx_anim_stack.xml' path='doc/member[@name="ufbx_anim_stack.time_begin"]/*' />
        public double time_begin;

        /// <include file='ufbx_anim_stack.xml' path='doc/member[@name="ufbx_anim_stack.time_end"]/*' />
        public double time_end;

        /// <include file='ufbx_anim_stack.xml' path='doc/member[@name="ufbx_anim_stack.layers"]/*' />
        public ufbx_anim_layer_list layers;

        /// <include file='ufbx_anim_stack.xml' path='doc/member[@name="ufbx_anim_stack.anim"]/*' />
