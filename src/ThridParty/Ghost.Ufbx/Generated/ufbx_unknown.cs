...
{
    /// <include file='ufbx_unknown.xml' path='doc/member[@name="ufbx_unknown"]/*' />
    public partial struct ufbx_unknown
    {
        /// <include file='ufbx_unknown.xml' path='doc/member[@name="ufbx_unknown.Anonymous"]/*' />
        [NativeTypeName("__AnonymousRecord_ufbx_L780_C2")]
        public _Anonymous_e__Union Anonymous;

        /// <include file='ufbx_unknown.xml' path='doc/member[@name="ufbx_unknown.type"]/*' />
        public ufbx_string type;

        /// <include file='ufbx_unknown.xml' path='doc/member[@name="ufbx_unknown.super_type"]/*' />
        public ufbx_string super_type;

        /// <include file='ufbx_unknown.xml' path='doc/member[@name="ufbx_unknown.sub_type"]/*' />
