...
{
    /// <include file='ufbx_nurbs_curve.xml' path='doc/member[@name="ufbx_nurbs_curve"]/*' />
    public partial struct ufbx_nurbs_curve
    {
        /// <include file='ufbx_nurbs_curve.xml' path='doc/member[@name="ufbx_nurbs_curve.Anonymous"]/*' />
        [NativeTypeName("__AnonymousRecord_ufbx_L1746_C2")]
        public _Anonymous_e__Union Anonymous;

        /// <include file='ufbx_nurbs_curve.xml' path='doc/member[@name="ufbx_nurbs_curve.basis"]/*' />
        public ufbx_nurbs_basis basis;

        /// <include file='ufbx_nurbs_curve.xml' path='doc/member[@name="ufbx_nurbs_curve.control_points"]/*' />
