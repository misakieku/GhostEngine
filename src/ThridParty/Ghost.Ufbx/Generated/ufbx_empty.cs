...
{
    /// <include file='ufbx_empty.xml' path='doc/member[@name="ufbx_empty"]/*' />
    public partial struct ufbx_empty
    {
        /// <include file='ufbx_empty.xml' path='doc/member[@name="ufbx_empty.Anonymous"]/*' />
