...
{
    /// <include file='ufbx_audio_layer.xml' path='doc/member[@name="ufbx_audio_layer"]/*' />
    public partial struct ufbx_audio_layer
    {
        /// <include file='ufbx_audio_layer.xml' path='doc/member[@name="ufbx_audio_layer.Anonymous"]/*' />
        [NativeTypeName("__AnonymousRecord_ufbx_L3399_C2")]
        public _Anonymous_e__Union Anonymous;

        /// <include file='ufbx_audio_layer.xml' path='doc/member[@name="ufbx_audio_layer.clips"]/*' />
