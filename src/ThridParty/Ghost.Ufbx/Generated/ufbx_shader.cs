...
{
    /// <include file='ufbx_shader.xml' path='doc/member[@name="ufbx_shader"]/*' />
    public partial struct ufbx_shader
    {
        /// <include file='ufbx_shader.xml' path='doc/member[@name="ufbx_shader.Anonymous"]/*' />
        [NativeTypeName("__AnonymousRecord_ufbx_L2999_C2")]
        public _Anonymous_e__Union Anonymous;

        /// <include file='ufbx_shader.xml' path='doc/member[@name="ufbx_shader.type"]/*' />
        public ufbx_shader_type type;

        /// <include file='ufbx_shader.xml' path='doc/member[@name="ufbx_shader.bindings"]/*' />
