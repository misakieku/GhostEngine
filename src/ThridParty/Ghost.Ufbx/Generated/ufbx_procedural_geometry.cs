...
{
    /// <include file='ufbx_procedural_geometry.xml' path='doc/member[@name="ufbx_procedural_geometry"]/*' />
    public partial struct ufbx_procedural_geometry
    {
        /// <include file='ufbx_procedural_geometry.xml' path='doc/member[@name="ufbx_procedural_geometry.Anonymous"]/*' />
