...
{
    /// <include file='ufbx_blend_deformer.xml' path='doc/member[@name="ufbx_blend_deformer"]/*' />
    public partial struct ufbx_blend_deformer
    {
        /// <include file='ufbx_blend_deformer.xml' path='doc/member[@name="ufbx_blend_deformer.Anonymous"]/*' />
        [NativeTypeName("__AnonymousRecord_ufbx_L2051_C2")]
        public _Anonymous_e__Union Anonymous;

        /// <include file='ufbx_blend_deformer.xml' path='doc/member[@name="ufbx_blend_deformer.channels"]/*' />
