...
{
    /// <include file='ufbx_selection_node.xml' path='doc/member[@name="ufbx_selection_node"]/*' />
    public unsafe partial struct ufbx_selection_node
    {
        /// <include file='ufbx_selection_node.xml' path='doc/member[@name="ufbx_selection_node.Anonymous"]/*' />
        [NativeTypeName("__AnonymousRecord_ufbx_L3274_C2")]
        public _Anonymous_e__Union Anonymous;

        /// <include file='ufbx_selection_node.xml' path='doc/member[@name="ufbx_selection_node.target_node"]/*' />
        public ufbx_node* target_node;

        /// <include file='ufbx_selection_node.xml' path='doc/member[@name="ufbx_selection_node.target_mesh"]/*' />
        public ufbx_mesh* target_mesh;

        /// <include file='ufbx_selection_node.xml' path='doc/member[@name="ufbx_selection_node.include_node"]/*' />
        [NativeTypeName("_Bool")]
        public bool include_node;

        /// <include file='ufbx_selection_node.xml' path='doc/member[@name="ufbx_selection_node.vertices"]/*' />
        public ufbx_uint32_list vertices;

        /// <include file='ufbx_selection_node.xml' path='doc/member[@name="ufbx_selection_node.edges"]/*' />
        public ufbx_uint32_list edges;

        /// <include file='ufbx_selection_node.xml' path='doc/member[@name="ufbx_selection_node.faces"]/*' />
