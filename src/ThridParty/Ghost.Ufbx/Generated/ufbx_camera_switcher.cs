...
{
    /// <include file='ufbx_camera_switcher.xml' path='doc/member[@name="ufbx_camera_switcher"]/*' />
    public partial struct ufbx_camera_switcher
    {
        /// <include file='ufbx_camera_switcher.xml' path='doc/member[@name="ufbx_camera_switcher.Anonymous"]/*' />
