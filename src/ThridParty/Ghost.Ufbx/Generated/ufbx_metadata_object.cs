...
{
    /// <include file='ufbx_metadata_object.xml' path='doc/member[@name="ufbx_metadata_object"]/*' />
    public partial struct ufbx_metadata_object
    {
        /// <include file='ufbx_metadata_object.xml' path='doc/member[@name="ufbx_metadata_object.Anonymous"]/*' />
