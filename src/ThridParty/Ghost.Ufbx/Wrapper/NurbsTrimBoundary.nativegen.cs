...
public unsafe struct NurbsTrimBoundary
{
    private ufbx_nurbs_trim_boundary* _ptr;

    internal NurbsTrimBoundary(ufbx_nurbs_trim_boundary* ptr)
    {
        _ptr = ptr;
    }
    ...
    internal ufbx_nurbs_trim_boundary* GetUnsafePtr() => _ptr;
}
