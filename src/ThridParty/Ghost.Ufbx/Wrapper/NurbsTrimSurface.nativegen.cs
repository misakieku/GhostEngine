...
public unsafe struct NurbsTrimSurface
{
    private ufbx_nurbs_trim_surface* _ptr;

    internal NurbsTrimSurface(ufbx_nurbs_trim_surface* ptr)
    {
        _ptr = ptr;
    }
    ...
    internal ufbx_nurbs_trim_surface* GetUnsafePtr() => _ptr;
}
